...
class _WinwheelState extends State<Winwheel>
  ...
  List? _segments;
  late WinwheelAnimation _animation;
  ...
  void computeAnimation() {
    ...
    if (_animation.direction == WinwheelAnimationDirection.anticlockwise) {
      _animation.propertyValue = (0 - _animation.propertyValue!);
      _animation.propertyValue =  _animation.propertyValue! - (360 - _animation.stopAngle!);
    } else {
      _animation.propertyValue = _animation.propertyValue! + _animation.stopAngle!;
    }
